# Institution Outreach Email Template

Subject: Request for research feedback on a local-first assistive biometrics prototype for nonverbal children

Dear [Name / Lab Team],

My name is [Your Name], and I am working with Genesis Lab Foundation on a charitable assistive technology prototype called Genesis Assistive Biometrics.
...
- It does not make diagnoses or automated clinical decisions.
- Processing is local-first in the browser.
- Raw video/audio is not stored by default.
- Outputs are shown as caregiver-confirmed hypotheses with confidence and evidence.
- We are especially interested in ethical validation, accessibility feedback, and failure cases.

We are looking for researchers, clinicians, or labs who can review the approach and advise us on whether and how it could be tested with people under an appropriate research protocol. We would value feedback on:

- study design and consent requirements,
- risks and safeguards for children and disabled participants,
- useful and misleading biometric signals,
- AAC vocabulary and child-facing UI design,
- validation metrics,
